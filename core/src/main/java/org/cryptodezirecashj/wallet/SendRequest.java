...
import org.cryptodezirecashj.wallet.KeyChain.KeyPurpose;
import org.cryptodezirecashj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.cryptodezirecashj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.cryptodezirecashj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
