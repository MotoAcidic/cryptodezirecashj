...
package org.cryptodezirecashj.wallet.listeners;
...
public interface WalletCoinsReceivedEventListener {
     ...
     * the object retrieved via {@link org.cryptodezirecashj.core.Transaction#getConfidence()}. It's safe to modify the
