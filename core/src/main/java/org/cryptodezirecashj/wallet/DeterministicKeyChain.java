 ...
 * {@link org.cryptodezirecashj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.cryptodezirecashj.crypto.MnemonicCode},
 ...
 * {@link org.cryptodezirecashj.crypto.DeterministicKey#serializePubB58(org.cryptodezirecashj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.cryptodezirecashj.crypto.DeterministicKey#deserializeB58(org.cryptodezirecashj.crypto.DeterministicKey, String, org.cryptodezirecashj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.cryptodezirecashj.crypto.DeterministicKey,KeyChainType keyChaintype)}.</p>
 *
 * <p>This class builds on {@link org.cryptodezirecashj.crypto.DeterministicHierarchy} and
 * {@link org.cryptodezirecashj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from cryptodezirecashj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.cryptodezirecashj.crypto.DeterministicKey)}
     ...
     * @see org.cryptodezirecashj.wallet.MarriedKeyChain
     */
