...
import org.cryptodezirecashj.core.Message;
...
import org.cryptodezirecashj.signers.*;
import org.cryptodezirecashj.utils.*;
import org.cryptodezirecashj.wallet.Protos.Wallet.*;
import org.cryptodezirecashj.wallet.WalletTransaction.*;
import org.cryptodezirecashj.wallet.listeners.KeyChainEventListener;
import org.cryptodezirecashj.wallet.listeners.ScriptsChangeEventListener;
...
import org.cryptodezirecashj.wallet.listeners.WalletEventListener;
import org.cryptodezirecashj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.cryptodezirecashj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.cryptodezirecashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.cryptodezirecashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.cryptodezirecashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.cryptodezirecashj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.cryptodezirecashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.cryptodezirecashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.cryptodezirecashj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.cryptodezirecashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.cryptodezirecashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.cryptodezirecashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.cryptodezirecashj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.cryptodezirecashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.cryptodezirecashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of cryptodezirecashj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.cryptodezirecashj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.cryptodezirecashj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.cryptodezirecashj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.cryptodezirecashj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.cryptodezirecashj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.cryptodezirecashj.crypto.KeyCrypter,
     ...
     * {@link org.cryptodezirecashj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.cryptodezirecashj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.cryptodezirecashj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.cryptodezirecashj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.cryptodezirecashj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.cryptodezirecashj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
