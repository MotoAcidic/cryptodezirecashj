...
/**
 * <p>A KeyChainGroup is used by the {@link org.cryptodezirecashj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.cryptodezirecashj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.cryptodezirecashj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.cryptodezirecashj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
