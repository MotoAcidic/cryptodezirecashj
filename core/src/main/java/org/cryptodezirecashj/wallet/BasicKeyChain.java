...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.cryptodezirecashj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.cryptodezirecashj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.cryptodezirecashj.crypto.KeyCrypter,
