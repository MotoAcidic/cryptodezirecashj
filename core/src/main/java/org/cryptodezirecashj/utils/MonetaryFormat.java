...
import org.cryptodezirecashj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    public static final String CODE_BTC = "CDZC";
    ...
    /**
     * Parse a human readable coin value to a {@link org.cryptodezirecashj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.cryptodezirecashj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
