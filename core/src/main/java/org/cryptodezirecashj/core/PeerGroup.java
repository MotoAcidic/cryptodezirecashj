...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of cryptodezirecashj fixes the known
     ...
     * {@link org.cryptodezirecashj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.cryptodezirecashj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.cryptodezirecashj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.cryptodezirecashj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.cryptodezirecashj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.cryptodezirecashj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.cryptodezirecashj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.cryptodezirecashj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.cryptodezirecashj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a cryptodezirecashj based app running in SPV mode to fully validating security.
     */
