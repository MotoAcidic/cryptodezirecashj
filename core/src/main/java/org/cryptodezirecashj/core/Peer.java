...
import org.cryptodezirecashj.net.StreamConnection;
import org.cryptodezirecashj.store.BlockStore;
import org.cryptodezirecashj.store.BlockStoreException;
import org.cryptodezirecashj.utils.ListenerRegistration;
 ...
 * {@link org.cryptodezirecashj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.cryptodezirecashj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.cryptodezirecashj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.cryptodezirecashj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.cryptodezirecashj.core.TxConfidenceTable}
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // cryptodezirecashj is a client mode implementation. That means there's not much point in us talking to other client
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.cryptodezirecashj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.cryptodezirecashj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.cryptodezirecashj.core.Peer#ping()} has never
